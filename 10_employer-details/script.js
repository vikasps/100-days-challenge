...
function submittingData(event) {
  ...
  const relativeMobileNumber = document.getElementById(
    "relativeMobileNumber"
  ).value;
  ...
  const inputsalaryperannum = document.getElementById(
    "inputsalaryperannum"
  ).value;
  ...
  if (firstName === "") {
    ...
    document.querySelector("#firstName").style.cssText =
...
function relatiMobileNo() {
  var relativeMobileNumber = document.getElementById(
    "relativeMobileNumber"
  ).value;
  if (relativeMobileNumber === "") {
    document
      .querySelector("#relativeMobileNumber")
